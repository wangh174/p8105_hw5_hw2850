...
```{r}
prop_test = function(unsolved_homicides, total){
  
  results = prop.test(unsolved_homicides, total) %>% 
    broom::tidy() %>% 
...
Baltimore_results = prop_test(pull(Baltimore, unsolved_homicides), pull(Baltimore, total))
```
Do prop.test with city Baltimore data. The estimate proportion of unsolved homicides is 0.6455607. The confidence interval is (0.6275625, 0.6631599).
